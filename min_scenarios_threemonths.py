...
def minimum_ai(param, start, end):
    ...
    time1 = time.time()
    dt = time1 - time0
    print("AI: Test min three months run seconds: ", dt, "value is:", minimumai)

minimumvalueai = minimum_ai(param_enum, start_date, threemonths)
...
def minimum_el_sc2(index, host, port, param_enum, start_date, end_date, doc_type):
    ...
    time1 =time.time()
    dt = time1-time0
    print("SC2: Test min three months run seconds",  dt, "value is:", valuemin)



minimumel = minimum_el_sc2("threemonths_minimumtest_final", "localhost", 9200, "NEI00008", start_date, threemonths, "_doc")
...
def minimum_el_sc3(index, host, port):
    ...
    time1 =time.time()
    dt = time1-time0
    print('SC3: Test min three months run seconds', dt, "value is:", valuemin)

minimumel_sc3 = minimum_el_sc3("threemonths_minimumtest_final", 'localhost', 9200)
