...
class TestCalculations(unittest.TestCase):
    def test_min_day(self):
        time0 = time.time()
        minimum = elasticevaluation.minimum_el_sc2("aday-minimumtest5", localhost, port, num_param1, start_date, day, doc_type)
        time1 = time.time()
        dt = time1 - time0
    ...
    def test_min_week(self):
        time0 = time.time()
        minimum = elasticevaluation.minimum_el_sc2("aweek-minimumtest5", localhost, port, num_param1, start_date, week, doc_type)
        time1 = time.time()
        dt = time1 - time0
    ...
    def test_min_year(self):
        time0 = time.time()
        minimum = elasticevaluation.minimum_el_sc2("ayear-minimumtest5", localhost, port, num_param1, start_date, year, doc_type)
        time1 = time.time()
        dt = time1 - time0
    ...
    def test_min_day_sc3(self):
        time0 = time.time()
        minimum = elasticevaluation.minimum_el_sc3("ayear-minimumtest5", localhost, port)
        time1 = time.time()
        dt = time1 - time0
        self.assertTrue(dt < 160)
